          ...
          <div>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
                  ...
                  return (
                    <React.Fragment>
                      <Link
                        ...
                        className={`group ${pathName === '/admin/dashboard' && 'bg-graydark'} relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark`}
                      >
                        <svg
                          className="fill-current"
                          width="18"
              ...
              <li>
                <Link
                  href="/admin/home"
                  className={`group ${pathName === '/admin/home' && 'bg-graydark'} relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark`}
                >
                  <svg
                    className="fill-current"
                    width="18"
              ...
              <li>
                <Link
                  href="/admin/about"
                  className={`group ${pathName === '/admin/about' && 'bg-graydark'} relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark`}
                >
                  <svg
                    className="fill-current"
                    width="18"
                  ...
                  return (
                    <React.Fragment>
                      <Link onClick={handleClick}
                        href=""
                        className={`group ${pathName === '/admin/events' && 'bg-graydark'} relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark`}
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <DropDown href="/admin/events/create">
                              Create Event
                            </DropDown>
                            <div className="mt-3" />
                            <DropDown href="/admin/events/view">
                              View Events
                            </DropDown>
                          </li>
                        </ul>
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <DropDown href="/admin/education/colleges">
                              Colleges
                            </DropDown>
                            <div className="mt-3" />
                            <DropDown href="/admin/education/ielts">
                              IELTS
                            </DropDown>
                            <div className="mt-3" />
                            <DropDown href="/admin/education/pte">
                              PTE
                            </DropDown>
                            <div className="mt-3" />
                            <DropDown href="/admin/education/py">
                              PY
                            </DropDown>
                          </li>
                        </ul>
                  ...
                  return (
                    <React.Fragment>
                      ...
                      >
                        <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                          <li>
                            <DropDown href="/admin/migration/student">
                              Student
                            </DropDown>
                            <div className="mt-3" />
                            <DropDown href="/admin/migration/tr">
                              TR
                            </DropDown>
                            <div className="mt-3" />
                            <DropDown href="/admin/migration/visitor">
                              Visitor
                            </DropDown>
                            <div className="mt-3" />
                            <DropDown href="/admin/migration/partner">
                              Partner
                            </DropDown>
                            <div className="mt-3" />
                            <DropDown href="/admin/migration/occupation">
                              Occupation
                            </DropDown>
                          </li>
                        </ul>
