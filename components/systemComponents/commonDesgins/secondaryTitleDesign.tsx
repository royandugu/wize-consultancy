    ...
    return (
        <div className={props.changeBg ? 'backgroundTwo' : 'backgroundOne'}>
            <div className="flex justify-center items-center gap-24 pt-72 pb-20 pr-[20%]">
                <div className="pl-[20%]">
                    <h1 className="uppercase text-[25px] xl+70:text-[45px] leading-3 mt-5"> {props.page === "about" ? 'About us': props.page==="events" ? 'EVENTS' : props.page === "ielts" ? 'IELTS CLASSES IN NEPAL' : props.page === "py" ? "PY CLASSES IN NEPAL" : props.page === "pte" && 'PTE CLASSESS IN NEPAL'}</h1>
