        ...
        <div className="welcomeSection">
            <div className="flex pt-40 justify-center gap-0">
                <div className="grid grid-cols-12 mt-5">
                    <div className="lg+100:col-span-5 col-span-12 hidden lg+100:block">
                        <img src="./images/students.png" className="ml-20"/>
                    </div>
                    <div className="lg+100:col-span-7 col-span-12 xl+70:mt-20 mt-[9%] pr-32 text-center lg+100:text-left">
